     ...
     */
                    ...
                    dayPicker: {
                        ...
                        titleFormatter: function titleFormatter(year, month) {
                            var titleDate = this.model.PersianDate.date([
                                year,
                                month,
                            ]);
                    ...
                    monthPicker: {
                        ...
                        onSelect: function onSelect(monthIndex) {
                            Helper.debug(
                                this,
                                "monthPicker Event: onSelect : " + monthIndex
                            );
                        },
                    },
                    ...
                    yearPicker: {
                        ...
                        titleFormatter: function titleFormatter(year) {
                            ...
                            var startYear = this.model.PersianDate.date([
                                remaining,
                            ]);
                            var endYear = this.model.PersianDate.date([
                                remaining + 11,
                            ]);
                            return (
                                startYear.format(
                        ...
                        onSelect: function onSelect(year) {
                            Helper.debug(
                                this,
                                "yearPicker Event: onSelect : " + year
                            );
                        },
                    },
                    ...
                    onSelect: function onSelect(unixDate) {
                        Helper.debug(
                            this,
                            "datepicker Event: onSelect : " + unixDate
                        );
                    },
                    ...
                    onSet: function onSet(unixDate) {
                        Helper.debug(
                            this,
                            "datepicker Event: onSet : " + unixDate
                        );
                    },
   ...
   */
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                (function ($) {
                    ...
                    $.fn.persianDatepicker = $.fn.pDatepicker = function (
                        options
                    ) {
                    ...
                    _createClass(Input, [
                        ...
                        },
                        {
                            ...
                            value: function _attachInputElementEvents() {
                                var that = this;
                                var closePickerHandler =
                                    function closePickerHandler(e) {
                                        if (
                                            !$(e.target).is(that.elem) &&
                                            !$(e.target).is(
                                                that.model.view.$container
                                            ) &&
                                            $(e.target).closest(
                                                "#" +
                                                    that.model.view.$container.attr(
                                                        "id"
                                                    )
                                            ).length == 0 &&
                                            !$(e.target).is(
                        ...
                        },
                        {
                            ...
                            value: function _updateAltField(unix) {
                                var value =
                                    this.model.options.altFieldFormatter(unix);
                        ...
                        },
                        {
                            ...
                            value: function getOnInitState() {
                                ...
                                if ($inputElem[0].nodeName === "INPUT") {
                                    inputValue =
                                        $inputElem[0].getAttribute("value");
                                } else {
                                ...
                                if (
                                    ...
                                    if (
                                        this.model.options.initialValueType ===
                                            "persian" &&
                                        inputValue
                                    ) {
                                        var parse = new PersianDateParser();
                                        var pd = new persianDate(
                                            parse.parse(inputValue)
                                        ).valueOf();
                                        ...
                                        garegurianDate = new Date(
                                            inputValue
                                        ).valueOf();
                                    }
                                    if (
                                        garegurianDate &&
                                        garegurianDate != "undefined"
                                    ) {
                    ...
                    _createClass(Navigator, [
                        {
                            ...
                            value: function liveAttach() {
                                // Check options
                                if (
                                    this.model.options.navigator.scroll.enabled
                                ) {
                                    var that = this;
                                    var gridPlot = $(
                                        "#" +
                                    ...
                                    Hamster(gridPlot).wheel(function (
                                        event,
                                        delta
                                    ) {
                                        if (delta > 0) {
                        ...
                        },
                        {
                            ...
                            value: function timeUp(timekey) {
                                if (
                                    this.model.options.timePicker[timekey] ==
                                    undefined
                                ) {
                                    return;
                                }
                                ...
                                if (timekey == "meridian") {
                                    step = 12;
                                    if (
                                        this.model.state.view.meridian == "PM"
                                    ) {
                        ...
                        },
                        {
                            ...
                            value: function timeDown(timekey) {
                                ...
                                if (timekey == "meridian") {
                                    step = 12;
                                    if (
                                        this.model.state.view.meridian == "AM"
                                    ) {
                                        t = this.model.PersianDate.date(
                                            this.model.state.selected.unixDate
                                        )
                                    ...
                                    $(document).on(
                                        ...
                                        function () {
                                            if ($(this).is(".pwt-btn-next")) {
                                                that.model.state.navigate(
                                                    "next"
                                                );
                                                that.model.view.render();
                                                that.model.options.navigator.onNext(
                                                    that.model
                                                );
                                            } else if (
                                                ...
                                                that.model.view.render();
                                                that.model.options.navigator.onSwitch(
                                                    that.model
                                                );
                                            } else if (
                                                ...
                                                that.model.view.render();
                                                that.model.options.navigator.onPrev(
                                                    that.model
                                                );
                                            }
                                        }
                                ...
                                if (this.model.options.dayPicker.enabled) {
                                    ...
                                    $(document).on(
                                        ...
                                        function () {
                                            ...
                                            that.model.options.dayPicker.onSelect(
                                                thisUnix
                                            );
                                            that.model.options.onSelect(
                                                thisUnix
                                ...
                                if (this.model.options.monthPicker.enabled) {
                                    ...
                                    $(document).on(
                                        ...
                                        function () {
                                            ...
                                            that.model.state.switchViewModeTo(
                                                "day"
                                            );
                                            if (
                                                !that.model.options
                                                ...
                                                if (
                                                    that.model.options.autoClose
                                                ) {
                                                    that.model.view.hide();
                                                    that.model.options.onHide(
                                                        that
                                                    );
                                                }
                                            }
                                            ...
                                            that.model.view.render();
                                            that.model.options.monthPicker.onSelect(
                                                month
                                            );
                                            that.model.options.onSelect(
                                                that.model.state.selected
                                ...
                                if (this.model.options.yearPicker.enabled) {
                                    ...
                                    $(document).on(
                                        ...
                                        function () {
                                            ...
                                            that.model.view.render();
                                            that.model.options.yearPicker.onSelect(
                                                year
                                            );
                                            that.model.options.onSelect(
                                                that.model.state.selected
                    ...
                    _createClass(Options, [
                        {
                            ...
                            value: function _compatibility(options) {
                                ...
                                persianDate.toLocale(
                                    options.calendar[options.calendarType]
                                        .locale
                                );
                                ...
                                if (options.timePicker.hour.step === null) {
                                    options.timePicker.hour.step =
                                        options.timePicker.step;
                                }
                                if (options.timePicker.minute.step === null) {
                                    options.timePicker.minute.step =
                                        options.timePicker.step;
                                }
                                if (options.timePicker.second.step === null) {
                                    options.timePicker.second.step =
                                        options.timePicker.step;
                                }
                    ...
                    _createClass(PersianDateWrapper, [
                        {
                            ...
                            value: function date(input) {
                                ...
                                var output = void 0,
                                    cp = void 0;
                                cp = persianDate.toCalendar(
                                    that.model.options.calendar_
                                );
                                if (
                                    this.model.options.calendar[
                                        this.model.options.calendarType
                                ...
                                output = new cp(input);
                                return output.toLocale(
                                    that.model.options.locale_
                                );
                            },
                        },
                    ]);
                    ...
                    _createClass(State, [
                        {
                            ...
                            value: function _setFilterDate(minDate, maxDate) {
                                ...
                                var pdEnd =
                                    self.model.PersianDate.date(maxDate);
                        ...
                        },
                        {
                            ...
                            value: function switchViewModeTo(viewMode) {
                                if (this.viewModeList.indexOf(viewMode) >= 0) {
                                    ...
                                    this.viewModeIndex =
                                        this.viewModeList.indexOf(viewMode);
                                }
                            },
                            ...
                            value: function setSelectedDateTime(key, value) {
                                ...
                                switch (key) {
                                    case "unix":
                                        ...
                                        var pd =
                                            this.model.PersianDate.date(value);
                    ...
                    _createClass(View, [
                        ...
                        },
                        {
                            ...
                            value: function setPickerBoxPosition() {
                                var inputPosition =
                                        this.model.input.getInputPosition(),
                        ...
                        },
                        {
                            ...
                            value: function _getNavSwitchText(data) {
                                ...
                                if (this.model.state.viewMode == "day") {
                                    ...
                                    this.model.state.viewMode == "month"
                                ) {
                                    output =
                                    ...
                                    this.model.state.viewMode == "year"
                                ) {
                                    output =
                        ...
                        },
                        {
                            ...
                            value: function checkYearAccess(year) {
                                ...
                                if (this.model.state.filetredDate) {
                                    var startYear =
                                            this.model.state.filterDate.start
                                                .year,
                                        endYear =
                        ...
                        },
                        {
                            ...
                            value: function _getYearViewModel(viewState) {
                                ...
                                var list = []
                                    .concat(
                                        _toConsumableArray(
                                            Array(this.yearsViewCount).keys()
                                        )
                                    )
                                    .map(function (value) {
                                        return (
                        ...
                        },
                        {
                            ...
                            value: function checkMonthAccess(month) {
                                ...
                                if (output) {
                                    return this.model.options.checkMonth(
                                        month,
                                        y
                                    );
                                }
                        ...
                        },
                        {
                            ...
                            value: function checkDayAccess(unixtimespan) {
                                ...
                                if (output) {
                                    return self.model.options.checkDate(
                                        unixtimespan
                                    );
                                }
                            },
                        ...
                        },
                        {
                            ...
                            value: function _getDayViewModel() {
                                ...
                                var pdateInstance =
                                        this.model.PersianDate.date(),
                                    daysCount = pdateInstance.daysInMonth(
                                        viewYear,
                                        viewMonth
                                    ),
                                    firstWeekDayOfMonth =
                                        pdateInstance.getFirstWeekDayOfMonth(
                                            viewYear,
                                            viewMonth
                                        ) - 1,
                                    outputList = [],
                            ...
                            value: function _getTimeViewModel() {
                                ...
                                return {
                                    ...
                                    hour: {
                                        title: hourTitle,
                                        enabled:
                                            this.model.options.timePicker.hour
                                                .enabled,
                                    },
                                    minute: {
                                        ...
                                        enabled:
                                            this.model.options.timePicker.minute
                                                .enabled,
                                    },
                                    second: {
                                        title: this.model.state.view.dateObject.format(
                        ...
                        },
                        {
                            ...
                            value: function getViewModel(data) {
                                ...
                                return {
                                    ...
                                    todayButtonText:
                                        this._getButtonText().todayButtontext,
                                    submitButtonText:
                                        this._getButtonText().submitButtonText,
                                };
                            },
                        },
                        {
                        ...
                        },
                        {
                            ...
                            value: function _getAnotherCalendar() {
                                ...
                                if (that.model.options.calendar_ == "persian") {
                                    ...
                                    cal = "persian";
                                    loc =
                                        that.model.options.calendar.persian
                                            .locale;
                                }
                                return [cal, loc];
                            },
                    ...
                    Hamster.event = {
                        ...
                        add: function add(
                            ...
                            handler = function (originalEvent) {
                                ...
                                var event =
                                        Hamster.normalise.event(originalEvent),
                                    delta =
                                        Hamster.normalise.delta(originalEvent);
                        ...
                        remove: function remove(
                            ...
                            var originalHandler = handler,
                                ...
                                handlers;
                            for (
                                var i = 0, len = hamster.handlers.length;
                                i < len;
                                ++i
                            ) {
                                lookup[hamster.handlers[i].original] =
                                    hamster.handlers[i];
                            }
                ...
                (function defineMustache(global, factory) {
                    ...
                    var isArray =
                        ...
                        function isArrayPolyfill(object) {
                            return (
                                objectToString.call(object) === "[object Array]"
                            );
                        };
                    ...
                    function parseTemplate(template, tags) {
                        ...
                        function compileTags(tagsToCompile) {
                            ...
                            if (
                                !isArray(tagsToCompile) ||
                                tagsToCompile.length !== 2
                            )
                                throw new Error(
                                    "Invalid tags: " + tagsToCompile
                                );
                    ...
                    function squashTokens(tokens) {
                        ...
                        var token, lastToken;
                        for (
                            var i = 0, numTokens = tokens.length;
                            i < numTokens;
                            ++i
                        ) {
                            token = tokens[i];
                    ...
                    Writer.prototype.parse = function parse(template, tags) {
                        var cache = this.cache;
                        var cacheKey =
                            template + ":" + (tags || mustache.tags).join(":");
                        var tokens = cache[cacheKey];

                        if (tokens == null)
                            tokens = cache[cacheKey] = parseTemplate(
                                template,
                                tags
                            );
                    ...
                    Writer.prototype.render = function render(
                        ...
                        var context =
                            view instanceof Context ? view : new Context(view);
                     ...
                     */
                    mustache.render = function render(
                        template,
                        view,
                        partials,
                        tags
